...
-- 7. Join the necessary tables to find the total quantity of 
...
-- 10.Group the orders by date and calculate the average number 
...
join order_details
on order_details.pizza_id= pizzas.pizza_id group by
